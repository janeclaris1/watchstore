...
export const FALLBACK_SHIPPING_RATES: LiveShippingRate[] = [
  {
    ...
    service: "Standard",
    name: "Aramex",
    description: "Reliable tracked delivery with discreet packaging",
    price: 24.99,
    currency: "USD",
  ...
  },
  {
    ...
    name: "FedEx",
    description: "Insured international and domestic courier service",
    price: 34.99,
    currency: "USD",
  ...
  },
  {
    ...
    name: "DHL Express",
    description: "Priority express courier with full tracking",
    price: 39.99,
    currency: "USD",
