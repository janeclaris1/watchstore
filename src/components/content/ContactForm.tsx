...
const fieldClass =
  "w-full bg-transparent border-0 border-b border-wf-border rounded-none px-0 py-3 text-sm text-wf-black placeholder:text-wf-gray/70 focus:outline-none focus:border-gold transition-colors duration-300";
...
export function ContactForm() {
  ...
  if (status === "sent") {
    return (
      <div className="animate-fade-up py-10 md:py-14">
        ...
        <h3 className="font-playfair text-3xl text-wf-black mb-4">
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-8 animate-fade-up">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 pt-2">
        <button
          ...
          className="btn-gold disabled:opacity-60 min-w-[180px]"
        >
